...
#include "com_indeed_vw_wrapper_learner_VWIntArrayLearner.h"
...
JNIEXPORT jintArray JNICALL Java_com_indeed_vw_wrapper_learner_VWIntArrayLearner_predict(JNIEnv *env, jobject obj, jstring example_string, jboolean learn, jlong vwPtr)
